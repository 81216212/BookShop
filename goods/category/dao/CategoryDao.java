package www.cmj.goods.category.dao;
...
public class CategoryDao {
	...
	public void add(Category category) throws SQLException {
		String sql = "insert into t_category(cid,cname,pid) values(?,?,?)";
		/*
	...
	public void edit(Category category) throws SQLException {
		...
		Object[] params = {category.getCname(), pid,category.getCid()};
		qr.update(sql, params);
	}
	 ...
	 * 查询是否存在分类名称
	 */
	public String findcname(String cname)throws SQLException  {
		String sql = "select cname from t_category where cname=? ";
		return (String) qr.query(sql, new ScalarHandler(),cname);
	}
}
