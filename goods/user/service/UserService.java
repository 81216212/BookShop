...
import www.cmj.goods.user.dao.UserDao;
...
public class UserService {
	 ...
	 * 修改用户激活功能
	 */
	public void useractivatioin(String uid) throws UserException {
		try {
			userDao.activation(true,uid);
		} catch(SQLException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public String ajaxValidateuser() {
		try {
			return userDao.ajaxValidateuser();
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public void regist(User user) {
		...
		// 例如MessageFormat.format("你好{0}, 你{1}!", "张三", "hhh"); 返回“你好张三，你hhh！”
	 ...
	 * 查询用户
	 */
	public PageBean<User> finduser(int pc) {
		try {
			return userDao.finduser(pc);
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
