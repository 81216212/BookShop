...
import www.cmj.goods.user.service.UserService;
import www.cmj.goods.user.service.UserException;
...
public class UserServlet extends BaseServlet {
	...
	public String ajaxValidateLoginnamenum(HttpServletRequest req,
			HttpServletResponse resp) throws ServletException, IOException {
		String num = userService.ajaxValidateuser();
	 ...
	 * 更改用户激活状态
	 */
	public String useractivation(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String uid = req.getParameter("uid");
		try {
			userService.useractivatioin(uid);
			req.setAttribute("success", "恭喜，激活成功！");
		} catch (UserException e) {
			req.setAttribute("success", "激活失败！");
		}
	...
	public String updatePassword(HttpServletRequest req,
		...
		try {
			...
			req.setAttribute("code", "success");
			req.getSession().invalidate();//销毁用户Session
			return "f:/jsps/user/pwdmsg.jsp";
		} catch (UserException e) {
	...
	public String finduser(HttpServletRequest req, HttpServletResponse resp)
		...
		PageBean<User > pb  = userService.finduser(pc);
		pb.setUrl(url);
