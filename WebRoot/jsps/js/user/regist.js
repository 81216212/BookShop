...
/*	
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/cmj/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/cmj/images/regist1.jpg");
		}
	);*/
...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/cmj/UserServlet",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/cmj/VerifyCodeServlet?a=" + new Date().getTime());
}
