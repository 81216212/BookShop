...
<div class="divBody">
  <div class="divContent">
    <%--上一页 --%>
<c:choose>
	<c:when test="${pb.pc eq 1 }"><span class="spanBtnDisabled">首页</span></c:when>
	<c:otherwise><a href="${pb.url }&pc=1" class="aBtn bold">首页</a></c:otherwise>
</c:choose>
...
<c:choose>
	<c:when test="${pb.pc eq pb.tp }"><span class="spanBtnDisabled">尾页</span></c:when>
	<c:otherwise><a href="${pb.url }&pc=${pb.tp }" class="aBtn bold">尾页</a></c:otherwise>
</c:choose> 
